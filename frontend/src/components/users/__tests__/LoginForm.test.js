...
describe('LoginForm', () => {
  ...
  describe('Validación de formulario', () => {
    test('debe mostrar error cuando el campo usuario está vacío', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText(/el nombre de usuario o correo es requerido/i)).toBeInTheDocument();
      });
    });
    ...
    test('debe limpiar errores cuando el usuario empieza a escribir', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByText(/el nombre de usuario o correo es requerido/i)).not.toBeInTheDocument();
      });
    });
  });
  ...
  describe('Envío del formulario', () => {
    ...
    test('debe deshabilitar el botón y mostrar "Iniciando sesión..." durante el proceso', async () => {
      ...
      // Verificar que el botón está deshabilitado y muestra el texto de carga
      await waitFor(() => {
  ...
  describe('Interacción con inputs', () => {
    ...
    test('debe deshabilitar inputs durante el proceso de login', async () => {
      ...
      // Los inputs deberían estar deshabilitados durante la carga
      await waitFor(() => {
